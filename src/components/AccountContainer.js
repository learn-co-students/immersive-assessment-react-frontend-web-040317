...
class AccountContainer extends Component {
  ...
  handleSearch(event){
    ...
    fetch(`https://boiling-brook-94902.herokuapp.com/transactions`).then(response => response.json()).then(transactions => this.setTransactions(transactions))
  ...
  render() {
    ...
    return (
      <div>
        <Search searchTerm={this.state.searchTerm} onChange={this.handleChange.bind(this)}  onClick={this.handleSearch.bind(this)}/>
